...
int randomIntBetween(int valMin, int valMax) {
    ...
    int nombre = valMin +
                 (int) (rand() / (RAND_MAX + 1.0) * (valMax - valMin + 1));  // rand and RAND_MAX defined in <stdlib.h>
    return nombre;
}
...
pid_t fork_and_run5(void (*run)(void *, void *, void *, void *, void *), void *arg0, void *arg1, void *arg2, void *arg3,
                    void *arg4) {
    int childId = fork();
    checkNeg(childId, "Fork failed");
